...
for file in $FILES; do
    # could add the model path as an argument to the script so I can use it better (it is now hardcoded)
    srun python3 multilingual_evaluation.py --test_set $file --model saved_models/downsampled_multilingual #--batch 8 --treshold 0.4 --epochs 5 --learning 8e-6
done
