...
srun cat monolingual_benchmark_files/swe_train.tsv | python3 register-benchmark.py monolingual_benchmark_files/swe_dev.tsv monolingual_benchmark_files/swe_test.tsv --batch 7 --treshold 0.6 --epochs 7
