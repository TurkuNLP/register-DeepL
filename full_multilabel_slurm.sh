...
DATAPATH="data/AfterDeepL/full_labels/"

echo "learning rate: $LR treshold: $TR batch: $BATCH epochs: $EPOCHS"


# PORTUGUESE
#srun python3 register-multilabel.py --train_set ${DATAPATH}pt_FINAL_full.tsv.gz --test_set data/test_sets/pt_test_modified.tsv --batch $BATCH --treshold $TR --epochs $EPOCHS --learning $LR --checkpoint ../multilabel/pt --lang pt --full

# SPANISH
#srun python3 register-multilabel.py --train_set ${DATAPATH}es_FINAL_full.tsv.gz --test_set data/test_sets/spa_test.tsv --batch $BATCH --treshold $TR --epochs $EPOCHS --learning $LR --checkpoint ../multilabel/spa --lang spa --full

#JAPANESE
srun python3 register-multilabel.py --train_set ${DATAPATH}ja_FINAL_full.tsv.gz --test_set data/test_sets/jpn_test.tsv --batch $BATCH --treshold $TR --epochs $EPOCHS --learning $LR --checkpoint ../multilabel/jpn --lang jpn --full
