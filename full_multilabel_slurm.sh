...
# echo $TEST
# srun python3 register-multilabel.py --train_set downsampled/all_downsampled_full.tsv.gz --test_set $TEST --batch $BATCH --treshold $TR --epochs $EPOCHS --learning $LR --checkpoint ../multilabel/downsampled --lang downsampled_pt --full
